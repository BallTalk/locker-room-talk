...
class SmsVerificationServiceUnitTest {
    ...
    @Test
    void 인증번호_발송_실패시_SmsVerificationException_sendFailed_예외가_발생하고_저장된코드_삭제한다() {
        // given
        String phone = "01012345678";
        SmsPurpose purpose = SmsPurpose.SIGNUP;
        SingleMessageSentResponse res = mock(SingleMessageSentResponse.class);
        ...
        SmsVerificationException ex = assertThrows(
    ...
    @Test
    void 인증번호가_존재하지_않거나_만료된_경우_SmsVerificationException_codeExpired_예외가_발생한다() {
        // given
    ...
    @Test
    void 인증번호_검증_불일치_코드인_경우_SmsVerificationException_codeMismatch_예외가_발생한다() {
        // given
        String phone = "01012345678";
        SmsPurpose purpose = SmsPurpose.SIGNUP;
    ...
    @Test
    void 인증번호_검증_코드가_null인_경우_SmsVerificationException_codeMismatch_예외가_발생한다() {
        // given
        String phone = "01012345678";
        SmsPurpose purpose = SmsPurpose.SIGNUP;

...
class GlobalExceptionHandlerTest {
    ...
    static class DummyBusinessException extends CustomException {
        DummyBusinessException(ErrorCode errorCode) {
            super(errorCode);
        }
    }
    ...
    static class TestController {
        ...
        public void custom() {
            throw new DummyBusinessException(ErrorCode.LOGIN_ID_REQUIRED);
        }
